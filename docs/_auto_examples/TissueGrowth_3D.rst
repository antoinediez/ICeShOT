...
.. "_auto_examples/TissueGrowth_3D.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download__auto_examples_TissueGrowth_3D.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr__auto_examples_TissueGrowth_3D.py:
...
.. _sphx_glr_download__auto_examples_TissueGrowth_3D.py:
